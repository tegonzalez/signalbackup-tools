...
class Arg
{
 ...
 public:
  ...
  void usage() const;
  inline std::string const &saveandroidbackup() const;
...
inline std::string const &Arg::saveandroidbackup() const
{
  return d_saveandroidbackup;
}
